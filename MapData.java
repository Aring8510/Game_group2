...
public class MapData {
	...
	MapData(int x, int y){ 
		...
		mapImage[TYPE_NONE] = new Image("png//SPACE.png");
		mapImage[TYPE_WALL] = new Image("png//WALL.png");
		mapImage[TYPE_ITEM] = new Image("png//mig.jpg");
                mapImage[TYPE_STEP] = new Image("png//step.png");
		width  = x;
		height = y;
		map = new int[y*x];
